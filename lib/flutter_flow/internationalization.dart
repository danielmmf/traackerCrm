...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // LpMain
  {
    ...
    'gcev8z2w': {
      ...
      'es':
          'O Nosso robo conectado a un GPT puede aprender sobre su empresa y lograr un atendimento automático de calidad y de alto rendimiento. O robo consegue ver usuarios, productos y servicios, pode abrir chamados, cobrar pix y validar se foi pago! Consegue consultar uma agenda ou ler documentos de referencia.',
      'pt':
          'O Nosso robô conectado a um GPT pode aprender sobre a sua empresa e fazer um atendimento automático de qualidade e de alto desempenho. O robo consegue ver usuários, produtos e serviços, pode abrir chamadas, cobrar pix e validar se foi pago! Consegue consultar uma agenda ou ler documentos de referência.',
    },
    'xy5qdx1k': {
      'en': 'Book Appointment',
      'es': 'Reservar una cita',
  ...
  // Clients
  {
    ...
    'f6mybgtr': {
      ...
      'es': 'A continuación se muestra un resumen de las tareas.',
      'pt': 'Abaixo está um resumo das tarefas.',
    },
    'u2vnhpte': {
      'en': 'All',
      'es': 'Todo',
    ...
    'ma2gxrfr': {
      ...
      'es': 'randy@nombrededominio.com',
      'pt': 'randy@nomedodomínio.com',
    },
    'k66u7cln': {
      'en': 'June 5th',
      'es': '5 de junio',
    ...
    '0tfdz0kv': {
      'en': 'emily@domain.com',
      'es': 'emily@dominio.com',
      'pt': 'emily@domínio.com',
    },
    '8xeuq84u': {
      'en': 'June 5th',
      'es': '5 de junio',
