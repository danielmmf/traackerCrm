...
class KanbanWidget extends StatefulWidget {
  const KanbanWidget({Key? key}) : super(key: key);

  @override
  _KanbanWidgetState createState() => _KanbanWidgetState();
}
...
class _KanbanWidgetState extends State<KanbanWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'kanban'});
